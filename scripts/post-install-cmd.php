...
exec("mv vendor/ojoven/mirendb/* .sql/");
// Necessary for hidden files
exec("mv vendor/ojoven/mirendb/.sqlignore .sql/");
...
ScriptFunctions::showMessageLine("Finally a control version system for your database.");
