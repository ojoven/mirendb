...
// WordPress
$isWordPress = ScriptFunctions::trueOrFalseDefaultFalse(ScriptFunctions::getUserInputValueFor("Is this a WordPress site?", "N", "y/N"));
$params['is_wordpress'] = $isWordPress;
if ($isWordPress) {
